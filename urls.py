...
urlpatterns = [
    ...
    url(r'^tracker/(?P<task>\d+)/(?P<subtask>\d+)/subtask.csv/?',  views.subtaskCSV,  name='subtaskCSV'),
    url(r'^tracker/(?P<task>\d+)/(?P<subtask>\d+)/subtask.json/?', views.subtaskJSON, name='subtaskJSON'),
    url(r'^tracker/(?P<task>\d+)/(?P<subtask>\d+)/subtask.txt/?',  views.subtaskTXT,  name='subtaskTXT'),
