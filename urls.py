...
urlpatterns = [
    ...
    url(r'^tracker/(?P<task>\d+)/sub/(?P<subtask>\d+)/add.csv/?',  views.subtaskCSV,  name='subtaskCSV'),
    url(r'^tracker/(?P<task>\d+)/sub/(?P<subtask>\d+)/add.json/?', views.subtaskJSON, name='subtaskJSON'),
    url(r'^tracker/(?P<task>\d+)/sub/(?P<subtask>\d+)/add.txt/?',  views.subtaskTXT,  name='subtaskTXT'),
